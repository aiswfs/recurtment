# Generated by Django 3.2.5 on 2022-01-18 06:00
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('email', models.CharField(blank=True, max_length=135, verbose_name='邮箱')),
                ...
                ('first_learning_ability', models.DecimalField(blank=True, decimal_places=1, max_digits=2, null=True, verbose_name='笔试成绩')),
                ...
                ('first_result', models.CharField(blank=True, choices=[('建议复试', '建议复试'), ('待定', '待定'), ('放弃', '放弃')], max_length=135, verbose_name='初试结果')),
                ...
                ('second_result', models.CharField(blank=True, choices=[('建议复试', '建议复试'), ('待定', '待定'), ('放弃', '放弃')], max_length=135, verbose_name='专业复试结果')),
                ('second_recommend_position', models.CharField(blank=True, max_length=256, verbose_name='建议方向或部门')),
                ...
                ('hr_logic_ability', models.CharField(blank=True, choices=[('S', 'S'), ('A', 'A'), ('B', 'B'), ('C', 'C')], max_length=10, verbose_name='HR思维逻辑')),
                ...
                ('hr_advantage', models.CharField(blank=True, choices=[('S', 'S'), ('A', 'A'), ('B', 'B'), ('C', 'C')], max_length=10, verbose_name='HR优势')),
                ('hr_disadvantage', models.CharField(blank=True, choices=[('S', 'S'), ('A', 'A'), ('B', 'B'), ('C', 'C')], max_length=10, verbose_name='HR顾虑和不足')),
                ('hr_interview', models.CharField(blank=True, max_length=256, verbose_name='HR面试官')),
                ...
                ('last_editor', models.CharField(blank=True, max_length=256, verbose_name='最后操作人')),
            ],
            options={
                'verbose_name': '应聘者',
